<template>
  <main class="flex">
    <aside class="md:w-[20%] lg:w-[20%]  w-[18%] bg-white max-h-screen sticky left-0 top-0 shadow-md flex flex-col justify-between">
        <div class="p-6">
            <h1 class="text-xl font-bold mb-4">Chatbot Dashboard</h1>
            <nav class="space-y-2">
        ...
        <!-- <div class="p-4 text-center text-gray-500">
            <p>Inspired by <a href="https://galichat.com" class="text-blue-500 underline">galichat.com</a></p>
        </div> -->
    </aside>
    <div class="md:w-[80%] lg:w-[80%] w-screen overflow-scroll">
      adada
      <slot/>
    </div>
  </main>
